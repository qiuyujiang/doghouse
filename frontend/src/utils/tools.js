...
export const setCookie = function(name,value,time){
    ...
    document.cookie=name + "=" + value +";expires="+date.toGMTString()+";Domain=.jdfmgt.com;path=/";  //设置cookie
}
export const delCookie = function(name){
    ...
    console.log(domain)
    if(cval!=null){
        document.cookie= name + "="+cval+";expires="+exp.toGMTString()+";Domain=.jdfmgt.com;path=/";
    }
}
export const getUrl = function(name){
    let reg = new RegExp("(^|[&?]{1})" + name + "=([^&]*)(|$)", "i");
...
export const getArrayObj = function(arr,key,val){
    let json = {};
...
export function getTableClassFn(className) {
